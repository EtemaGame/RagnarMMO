...
- `MobManualCommand`
- `ManualMobCatalogScreen`
- `ManualMobInspectorScreen`
- `ManualMobEditorScreen`
...
- [x] Add admin command flow for internal manual entry CRUD (`/ragnar mobmanual ...` and `/mobmanual` alias).
- [x] Add GUI catalog + inspector + editor.
