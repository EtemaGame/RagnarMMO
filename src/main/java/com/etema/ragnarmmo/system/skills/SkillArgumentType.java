...
public class SkillArgumentType implements ArgumentType<net.minecraft.resources.ResourceLocation> {
    ...
    public net.minecraft.resources.ResourceLocation parse(StringReader reader) throws CommandSyntaxException {
        ...
        if (input.contains(":")) {
            ...
            id = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("ragnarmmo", input);
        }
        ...
        if (!com.etema.ragnarmmo.system.skills.data.SkillRegistry.contains(id)) {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return SharedSuggestionProvider.suggest(
                com.etema.ragnarmmo.system.skills.data.SkillRegistry.getAllIds().stream()
