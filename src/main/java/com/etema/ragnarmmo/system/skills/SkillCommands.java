...
public final class SkillCommands {
        ...
        private static int showAllSkills(CommandSourceStack source, IPlayerSkills skills) {
                ...
                for (com.etema.ragnarmmo.common.api.skills.SkillCategory category : com.etema.ragnarmmo.common.api.skills.SkillCategory
                                .values()) {

                        // Filter skills by category using Registry
                        java.util.List<net.minecraft.resources.ResourceLocation> categorySkills = com.etema.ragnarmmo.system.skills.data.SkillRegistry
                                        .getAllIds().stream()
                                        .filter(id -> com.etema.ragnarmmo.system.skills.data.SkillRegistry.get(id)
                        ...
                        for (net.minecraft.resources.ResourceLocation id : categorySkills) {
                                ...
                                if (skills instanceof SkillManager sm) {
                                        com.etema.ragnarmmo.system.skills.data.SkillState state = sm.getSkillState(id);
                                        if (state != null) {
                                ...
                                String displayName = com.etema.ragnarmmo.system.skills.data.SkillRegistry.get(id)
        ...
        private static int showSkillInfo(CommandSourceStack source, IPlayerSkills skills,
                ...
                var defOpt = com.etema.ragnarmmo.system.skills.data.SkillRegistry.get(skillId);
                if (defOpt.isEmpty()) {
                ...
                double nextXp = com.etema.ragnarmmo.system.skills.data.SkillState.calculateXpToLevel(level + 1);
