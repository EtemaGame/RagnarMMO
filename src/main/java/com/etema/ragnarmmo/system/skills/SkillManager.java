 ...
 */
public class SkillManager implements com.etema.ragnarmmo.common.api.skills.IPlayerSkills {
    ...
    private int addXPInternal(ResourceLocation skillId, double amount, boolean bypassJobGating) {
        ...
        if (!bypassJobGating && player instanceof ServerPlayer serverPlayer
            ...
            boolean isNovice = def.getTier() == com.etema.ragnarmmo.common.api.skills.SkillTier.NOVICE;
    ...
    public void startCast(ResourceLocation skillId, int duration) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            ...
            com.etema.ragnarmmo.common.net.Network.sendToPlayer(serverPlayer,
                    new com.etema.ragnarmmo.system.skills.network.ClientboundCastUpdatePacket(skillIdStr, duration,
                            duration));
        }
    }
    ...
    public void interruptCast() {
        if (activeCastSkillId != null) {
            ...
            if (player instanceof ServerPlayer serverPlayer) {
                com.etema.ragnarmmo.common.net.Network.sendToPlayer(serverPlayer,
                        new com.etema.ragnarmmo.system.skills.network.ClientboundCastUpdatePacket("", 0, 0));
            }
        }
    }
    ...
    public void deserializeNBT(CompoundTag tag) {
        ...
        for (String key : tag.getAllKeys()) {
            ...
            if (key.contains(":")) {
                ...
                skillId = ResourceLocation.fromNamespaceAndPath(DEFAULT_NAMESPACE, key.toLowerCase());
            }
