...
public class SkillProgress {
    ...
    public static double calculateXpToLevel(int targetLevel) {
        ...
        if (targetLevel == 1)
            return 100.0;
        return com.etema.ragnarmmo.system.skills.global.SkillTypeGlobal.BASE_XP
                * Math.pow(com.etema.ragnarmmo.system.skills.global.SkillTypeGlobal.XP_MULTIPLIER, targetLevel - 2);
    }
