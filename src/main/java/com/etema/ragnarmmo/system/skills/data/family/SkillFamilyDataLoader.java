...
public class SkillFamilyDataLoader extends SimpleJsonResourceReloadListener {
    ...
    private SkillFamily parseFamily(ResourceLocation id, JsonObject json) {
        ...
        ResourceLocation fullId = ResourceLocation.fromNamespaceAndPath(
                json.has("id") ? parseId(json.get("id").getAsString()).getNamespace() : id.getNamespace(),
                json.has("id") ? parseId(json.get("id").getAsString()).getPath() : id.getPath());
