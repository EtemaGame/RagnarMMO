...
public class AnkleSnareSkillEffect implements ISkillEffect {
    ...
    public AnkleSnareSkillEffect() {
        this.definition = new HunterTrapManager.TrapDefinition(
                ...
                (trap, target) -> {
                    // Trigger Logic: 10 seconds of very high Slowness to emulate root
                    target.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20 * 10, 255, false, true));
                });
    }
