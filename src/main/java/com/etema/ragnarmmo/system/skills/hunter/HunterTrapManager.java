...
public class HunterTrapManager {
    ...
    public static class TrapInstance {
        ...
        public TrapInstance(Player owner, TrapDefinition definition, BlockPos position, ServerLevel level) {
            this.owner = owner;
     ...
     */
    public static void placeTrap(Player owner, ServerLevel level, BlockPos pos, TrapDefinition definition) {
        ACTIVE_TRAPS.computeIfAbsent(level, l -> new ArrayList<>())
                .add(new TrapInstance(owner, definition, pos, level));
    }
