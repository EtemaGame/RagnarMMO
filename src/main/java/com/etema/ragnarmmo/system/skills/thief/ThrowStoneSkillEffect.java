...
public class ThrowStoneSkillEffect implements ISkillEffect {
    ...
    public void execute(ServerPlayer player, int level) {
        ...
        final float baseDamage = 3.0f; // Fixed damage

        // Preparation delay (5 ticks)
        com.etema.ragnarmmo.system.skills.SkillSequencer.schedule(5, () -> {
            ...
            com.etema.ragnarmmo.system.skills.entity.MagicProjectileEntity projectile = 
                new com.etema.ragnarmmo.system.skills.entity.MagicProjectileEntity(player.level(), player, baseDamage, 
            ...
            // No homing for physical stones
            
            projectile.setPos(startPos.x, startPos.y, startPos.z);
            projectile.shoot(shootDir.x, shootDir.y, shootDir.z, 1.5f, 0); 
